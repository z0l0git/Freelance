...
import { FaFacebook, FaInstagram, FaPinterest, FaTwitter, FaLinkedin, FaGithub } from "react-icons/fa";
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-around">
            <div className="w-[380px] h-fit flex  items-center justify-center rounded-lg bg-white border border-black">
                <div className="w-[350px] h-fit flex flex-col justify-around border border-black">
                    <strong className="text-[32px] font-sans font-semibold">Budget</strong>
            ...
            <div className="w-[380px] h-[164px] flex  items-center  justify-center rounded-lg border border-inherit">
