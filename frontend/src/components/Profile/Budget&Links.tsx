...
export const BadgetAndLinks = () => {
  return (
    <div className="w-[402px] h-fit md:w-[416px] md:h-fit flex flex-col items-center justify-around gap-[20px] ">
      <div className="w-[354px] md:w-[380px] h-fit py-5 flex  items-center justify-center rounded-lg bg-white border border-black">
        <div className="w-[334px] h-fit  flex flex-col justify-around ">
          <strong className="text-[32px] font-sans font-semibold">
            Budget
          </strong>
          <div className="w-[344px] h-[64px] md:w-[816px] md:h-[79px] flex items-center gap-[10px] ">
          ...
          <div className="w-[334px] h-[51px] md:w-[354px] md:h-[54px] flex items-center justify-between">
            <p>Per Pages</p>
          ...
          <div className="w-[354px] md:w-[816px]">
            <BlueButton buttonName="Send Proposal" />
          </div>
        </div>
      </div>
      <div className="w-[380px] h-fit flex  items-center  justify-center rounded-lg py-5 bg-white border border-black">
