...
export const HeaderRight = (props) => {
  ...
  return (
    <div className="relative  h-[80px] flex items-center justify-center  md:w-[574px] md:h-[60px] md:flex md:items-center md:justify-between">
      <div className="w-[159px] h-[33px] flex items-center justify-between md:w-[400px] md:h-[60px] md:rounded-3xl md:border md:border-[#3f3877] md:flex md:items-center md:justify-around ">
        <button
          ...
          className="w-[30px] h-[30px] flex items-center justify-center border border-black rounded-full  md:hidden"
        >
          <CiSearch
        ...
        <div className="md:flex md:items-center">
          <CiSearch
            className="hidden md:block md:w-[25px] md:h-[25px] text-white"
            width={20}
            height={20}
          />
          <input
            ...
            name="name"
            placeholder="Search"
            className="hidden md:block md:w-[205px] md:h-[30px] md:bg-transparent border-transparent text-white"
          />
        </div>
        <div className="hidden md:relative md:w-[382px] md:flex md:flex-col md:items-center md:rounded-full">
          {!open ? (
            <div
              ...
              className="md:w-fit md:h-[42px] md:cursor-pointer md:px-4 md:gap-[10px] md:rounded-full md:bg-[#0D47A1] md:text-white flex justify-around items-center  border-transparent duration-300"
            >
              <h1>{select}</h1>
              <FaChevronDown />
            </div>
            ...
            <div
              onClick={() => setOpen((prev) => !prev)}
              className="md:w-fit md:h-[42px] md:px-4 md:cursor-pointer md:gap-[10px] md:rounded-full md:bg-[#0D47A1] md:text-white flex justify-center items-center"
            >
              <h1>{select}</h1>
              <FaChevronUp />
            </div>
        ...
        {show && (
          ...
          >
            ...
            <button
              ...
              className="w-[109px] h-[60px]  bg-[#0D47A1] text-white text-[36px] cursor-pointer"
            >
              Close
            </button>
          </motion.div>
