...
export const StickyHome = () => {
  return (
    <div className="bg-[url(https://res.cloudinary.com/dxarul6xr/image/upload/v1711522283/a3xj4objgeywljih9bpi.jpg)] bg-no-repeat bg-cover xl:bg-contain bg-right w-screen py-[110px] h-fit flex items-center">
      <div className=" h-full flex ">
        <div className="h-[70%] sm:py-[100px] py-[10px] rounded-[18px] pr-[30px] pl-[10px] flex flex-col gap-[20px] justify-center bg-white mx-[40px] w-full">
